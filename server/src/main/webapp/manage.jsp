...
<body>
	...
	<div id="header">
		<h1>
			<a href="./dashboard.html">FreeWifiAdmin</a>
		</h1>
	</div>
	...
	<div id="user-nav" class="navbar navbar-inverse">
		<ul class="nav btn-group">
			<li class="btn btn-inverse"><a title="" href="#"><i
					class="icon icon-user"></i> <span class="text">个人资料</span></a></li>
			<li class="btn btn-inverse"><a title="" href="#"><i
	...
	<div id="sidebar">
		...
		<ul>
			...
			<li><a href="editor.html"><i class="icon
				icon-edit"></i>
					<span>Edit</span></a></li>
			<li class="active"><a href="widgets.html"><i
					class="icon icon-dashboard"></i> <span>Manage</span></a></li>
		</ul>
	...
	<div id="content">
		...
		<div id="breadcrumb">
			<a href="#" title="Go to Home" class="tip-bottom"><i
				class="icon-home"></i> Home</a> <a href="#" class="current">Manage</a>
		</div>
							...
							<ul class="recent-posts" id="recent-posts">
								<li>
									<div class="article-post">
										<span class="user-info"> By: neytiri on 2 Aug 2012,
											09:27 AM, IP: 186.56.45.7 </span>
										<p>
										...
										<a href="#"
											...
											btn-success
											btn-mini">Publish</a>
										<a href="#" class="btn btn-success btn-mini">Unpublish</a> <a
											href="#" class="btn btn-success btn-mini">Preview</a> <a
											href="#" class="btn btn-danger btn-mini">Delete</a>
									</div>
								</li>
							</ul>
						</div>
