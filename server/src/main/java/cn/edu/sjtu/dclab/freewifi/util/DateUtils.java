...
public class DateUtils {
    ...
    /**
     * 获得给定时间的第N天零时的日期对象 例如：若给定时间为（2004-08-01 11:30:58），将获得（2004-08-02 00:00:00）的日期对象 若给定时间为（2004-08-31
    ...
    /**
     * #func 格式化日期<br>
     * #desc 使用yyyyMMddHHmmss作为样式
     * 
     * @author hedan
     * @version VERSION
     */
    public static String format(Date date) {
        return DateFormatUtils.format(date, ISO_DATETIME_FORMAT.getPattern());
    }
    ...
    public static Date parseDate(String date) {
        ...
        try {
            return org.apache.commons.lang.time.DateUtils.parseDate(date,
                    new String[] { ISO_DATETIME_FORMAT.getPattern() });
        } catch (ParseException e) {
            return null;
        }
    }
    ...
    /**
     * 获得给定时间的第二天零时的日期对象 例如：若给定时间为（2004-08-01 11:30:58），将获得（2004-08-02 00:00:00）的日期对象 若给定时间为（2004-08-31
     * 11:30:58），将获得（2004-09-01 00:00:00）的日期对象
     * 
     * @param dt Date 给定的java.util.Date对象
     * 
    ...
    /**
     * 如果当天在后续这个月不存在这天，则返回期望这个月后一个月的第一天 20081231 - 1 返回20081201 20080831 + 1 返回20080930
     * 
     * @param dt
     * @param n
     * 
    ...
    /**
     * 获得当前时间的第二天零时的日期对象 例如：若当前时间为（2004-08-01 11:30:58），将获得（2004-08-02 00:00:00）的日期对象 若当前时间为（2004-08-31
     * 11:30:58），将获得（2004-09-01 00:00:00）的日期对象
     * 
     * @return Date java.util.Date对象
     */
     ...
     * @author zhengbingwen
     */
    public static long getMidnightTimeInMillionSeconds() {
        Calendar c = Calendar.getInstance();
        c.set(Calendar.HOUR_OF_DAY, 0);
        c.set(Calendar.SECOND, 0);
        c.set(Calendar.MINUTE, 0);
     ...
     *         <code>false</code>:无重合
     */
    public final static boolean isOverlay(Date date1Start, Date date1End, Date date2Start, Date date2End) {
     ...
     *         <code>false</code>:无重合
     */
    public final static boolean isOverlay(String date1StartStr, String date1EndStr, String date2StartStr,
     ...
     * @return
     */
    public final static long getDaysBetweenIgnoreTime(String startDate, String endDate, Format format) {
        SimpleDateFormat localFormat = (SimpleDateFormat) format;
        try {
            java.util.Date startDay = localFormat.parse(startDate);
            java.util.Date endDay = localFormat.parse(endDate);
     ...
     * @return
     */
    public final static long getDaysBetweenIgnoreTime(Date startDate, Date endDate) {
