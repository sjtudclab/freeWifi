 ...
 * @data 2015-1-23
 */
public class UserInfoWeb extends Activity{
	private static final String TAG = "UserInfoWeb";
...
//	        }
		...
		webView.addJavascriptInterface(new Object(){
			...
			public void sendRegInfo(final String gender, final String birthday, final String tel, final  String pwd,
									final String education, final String income,
									final String engage, final String baby, final String job) {
	            handler.post(new Runnable() {
	                public void run() {
	                	Log.i(TAG, "sendRegInfo()");
						Log.i(TAG, gender + " " + birthday + " " + tel + " " + pwd + " " + education + " " + income + " " +
							engage + " " + baby + " " + job + " ");
						SharedDataTool.WriteRegisterInfo(getApplicationContext(), gender, birthday,
								tel, pwd, education, income, engage, baby, job);//先保存一份到本地
