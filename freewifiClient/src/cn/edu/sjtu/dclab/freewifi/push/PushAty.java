        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.initPush:
                    ...
                    Toast.makeText(getApplicationContext(), "接受推送", Toast.LENGTH_SHORT).show();
                    break;

                case R.id.stopPush:
                    JPushInterface.stopPush(getApplicationContext());
                    Toast.makeText(getApplicationContext(), "停止接受推送", Toast.LENGTH_SHORT).show();
                    break;

                case R.id.resumePush:
                    JPushInterface.resumePush(getApplicationContext());
                    Toast.makeText(getApplicationContext(), "重新接受推送", Toast.LENGTH_SHORT).show();
                    break;
